...
export const changelog: ChangelogEntry[] = [
  {
    version: "0.8.222",
    date: "2026-04-20",
    summary: "Version ve changelog tek dosyada birleştirildi (release.ts).",
    changes: [
      { type: "refactor", text: "`src/config/version.ts` ve `src/config/changelog.ts` içerikleri `src/config/release.ts` dosyasında birleştirildi; tek doğruluk kaynağına geçildi." },
      { type: "fix", text: "auto-merge metadata conflict listesi `src/config/release.ts` dosyasını kapsayacak şekilde güncellendi." },
      { type: "chore", text: "Versiyon `v0.8.222` olarak artırıldı ve buildDate Europe/Istanbul saatine göre güncellendi." },
    ],
  },
  {
    version: "0.8.221",
