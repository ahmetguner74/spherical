...
export function MapTab() {
  ...
  const filteredPermissions = layerFilter === "operations" ? [] : flightPermissions;
  ...
  return (
    <div className="space-y-3">
      ...
      <MapOperations
        ...
        onSelectOperation={(op) => { setSelectedOp(op); setIsDetailOpen(true); }}
          ...
          {LEGEND.map((item) => (
            <div key={item.label} className="flex items-center gap-1.5">
              <div
                ...
                style={{ backgroundColor: item.color, boxShadow: "0 1px 3px rgba(0,0,0,0.3)" }}
              />
      ...
      <OperationModal
        ...
        onSave={(data) => { if (selectedOp) updateOperation(selectedOp.id, data); }}
