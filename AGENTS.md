...
- **AGENTS.md her oturum başında okunur.** Kurallar tekrar sorulmaz.
- **AGENTS.md dinamik güncellenir.** Sohbet sırasında projenin yapısı, mimarisi, hedefleri veya kararları değiştiğinde AGENTS.md anında güncellenir. Bu dosya her zaman en güncel ve en doğru hali yansıtmalı. Eski/geçersiz bilgi bırakılmaz, üzerine yazılır. Her commit'te AGENTS.md kontrol edilir.
...
2. **AGENTS.md'Yİ GÜNCEL TUT.** Her yapısal değişiklikten sonra (sekme ekleme/silme, teknoloji değişikliği, mimari karar) AGENTS.md'deki ilgili bölümü HEMEN güncelle. Eski bilgi = yanlış bilgi = YASAK.
